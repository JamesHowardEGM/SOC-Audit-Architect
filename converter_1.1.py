...
def start_automated_audit():
    ...
    sync_confirm = messagebox.askyesno("SharePoint Sync Check", 
        ...
        "1. Have you navigated to 'Sentinel Audits' in your browser?\n"
        "2. Have you clicked 'Add shortcut to OneDrive'?\n\n"
        "This is required to save the audit files correctly.\n\n"
        "If this message does not make any sense:\n"
        "Read the documentation located in the same folder you found this script.\n\n"
        "If you're still having issues: Speak to Jaynil.")
    ...
    # --- TARGET: THE ONEDRIVE SHORTCUT ---
    onedrive_shortcut_path = os.path.join(
        os.path.expanduser("~"), 
        "OneDrive - OneStep Group", 
        "Stream - SOC - Sentinel Audits"
    )
